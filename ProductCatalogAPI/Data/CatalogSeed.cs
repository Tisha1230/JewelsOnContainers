...
namespace ProductCatalogAPI.Data
{
    public static class CatalogSeed
    {
        ...
        {
            catalogContext.Database.Migrate(); //apply all the changes in database
            if (!catalogContext.CatalogBrands.Any()) //If no records, insert some sample data
            {
                catalogContext.CatalogBrands.AddRange(GetCatalogBrands()); // doing bulk insert and passing array of CatalogBrands executing method GetCatalogBrand

                catalogContext.SaveChanges();
            
            }

            if (!catalogContext.CatalogTypes.Any()) //If no records, insert some sample data
            {
        ...
        private static IEnumerable<CatalogBrand> GetCatalogBrands() //Ienumerable allows only loop through it vs array allows adding and deleting from list
        {
